                    ...
                    <div className="founder-inner-wrapper">
                        <div className="text-block">
                            <span data-w-id="2e54cb1c-a00f-c062-adce-16af9176beec"
                                ...
                                Maia is a disrupting tech in passwordless authentication. Maia's novel architecture
                            </span>
                            ...
                            <span data-w-id="4e956d46-49a9-6df6-2ed7-5e78f3710d61" className="span-slide-in-up">
                                offers a seamless (stealthy) authorization experience for the users. Moreover, Maia

                            </span>



                            <span data-w-id="7149af9d-cd37-425f-bf35-46bcf4e9ee74" className="span-slide-in-up">ensures security even if user credentials are compromised; hence there are no</span>

                            <span data-w-id="d7767ba3-59ed-1403-d78c-019fc930e65c" className="span-slide-in-up">harmful consequences of user corruption or phishing attacks.</span>
                        </div>
